...
const ContactRegister = ({
  ...
  const isDateRange = (selectedDate) => {
  ...
  const isSecondDateUnselected = (fecha) => {
    if (Array.isArray(fecha) && fecha.length === 2) {
      const secondDate = fecha[1];
      return secondDate === "1969-12-31T03:00:00.000Z";
    }
  ...
  const horarios = [
    { label: "Mañana (8am a 12am)", value: "Mañana" },
    { label: "Tarde (12am a 17pm)", value: "Tarde" },
    { label: "Noche (17pm a 21pm)", value: "Noche" },
  ];
  ...
  const handleSubmit = (event) => {
    ...
    if (!horario) {
      setErrorHorario("Por favor, indique un horario.");
      return;
    }

    if (!direccion) {
      setErrorDireccion("Por favor, indique una dirección.");
      return;
    }
    ...
    const isRange = isDateRange(fecha);

    if (!isRange) {
      setErrorFecha("Por favor ingrese un rango de fechas");
      return;
    }

    if (isSecondDateUnselected(fecha)) {
        ...
        <div className="col-md-4 mx-auto">
          <div className="card">
            <div className="card-header text-center">
              ...
              <h6>
                Complete el siguiente formulario para solicitar un trabajo a{" "}
            ...
            <div className="card-body">
              <form onSubmit={handleSubmit}>
                <div className="form-group mt-2">
                  <h6>
                    Seleccione el tipo de trabajo que desea que el profesional
                    desarrolle.
                  </h6>
                  <select
                  ...
                  {categoria === "otro" && (
                    <div className="form-group mt-2">
                      <label htmlFor="otroTrabajo">
                        Ingrese una breve descripción del trabajo que desea:
                      </label>
                      <input
                        type="text"
                ...
                <br />
                <div className="form-group mt-2">
                  <h6>Seleccione el horario en el que desea la visita.</h6>
                  <select
                  ...
                  {errorHorario && (
                    <div className="text-danger">{errorHorario}</div>
                  )}
                </div>
                <br />
                <div className="form-group mt-2">
                  <h6>
                    Inserte la dirección a la cual se requiera el servicio.
                  </h6>
                  <input
                    className="form-control"
                    type="text"
                    placeholder="Inserte su direccion aquí"
                    name="direccion"
                    id="direccion"
                    value={direccion}
                  ...
                  />
                  {errorDireccion && (
                    <div className="text-danger">{errorDireccion}</div>
                  )}
                </div>
                ...
                <div className="form-group mt-2">
                  <h6>
                    Ingrese un rango de fechas en las que podria pactar con el
                    profesional:
                  </h6>
