...
const PoliticaDePrivacidad = () => {
  useTitle("Terminos y Condiciones");
  return (
    <>
      <div className="faq-container" style={{ fontFamily: "Inter" }}>
        <br></br>
        <br></br>
        <br></br>
        <h3 style={{ color: "black" }}>Política de Privacidad</h3>
        <p>
          El presente Política de Privacidad establece los términos en que
          DATAZO usa y protege la información que es proporcionada por sus
          ...
          <br></br>
          <b>Responsabilidad del cliente</b>
          <br></br>
          Una vez que el cliente realiza una llamada telefónica al número de
          contacto proporcionado por el profesional a través de nuestra
          plataforma, DATAZO no asume ninguna responsabilidad por los eventos,
          incidentes, daños, estafas o cualquier otro tipo de consecuencias que
          puedan ocurrir durante o como resultado de dicha comunicación.
          <br></br>
          <br></br>
          <b>Uso responsable</b>
          <br></br>
          El cliente se compromete a utilizar la aplicación de manera
          responsable y a no incurrir en ningún acto ilegal, fraudulento o
          dañino hacia otros usuarios o profesionales. Cualquier conducta
          inapropiada o violación de los términos y condiciones por parte del
          cliente puede resultar en la suspensión o cancelación de su cuenta,
          sin perjuicio de cualquier acción legal adicional que pueda tomar
          DATAZO.<br></br>
          <br></br>
          <b>Riesgos inherentes a la comunicación telefónica</b>
          <br></br>
          El cliente reconoce que la comunicación telefónica puede conllevar
          riesgos, incluyendo pero no limitándose a la divulgación de
          información personal, la exposición a actividades fraudulentas, la
          realización de transacciones no autorizadas, o cualquier otro tipo de
          evento perjudicial o negativo. Por lo tanto, el cliente asume la
          responsabilidad total y exime a Datazo de cualquier responsabilidad
          derivada de dichos riesgos.<br></br>
          <br></br>
          ...
          o realizar una entrega o facturación.<br></br>
          <br></br>
          <b>Uso de información recogida</b>
          <br></br>
          ...
          <br></br>
          DATAZO está altamente comprometido para cumplir con el compromiso de
          ...
          respecto al tráfico web recurrente. Otra función que tienen las
          ...
          ser de su interés. Una vez que usted de click en estos enlaces y
          ...
          que usted está de acuerdo con estas.<br></br>
          <br></br>
          ...
          requerido por un juez con un orden judicial. DATAZO Se reserva el
          derecho de cambiar los términos de la presente Política de Privacidad
          en cualquier momento. Todos los derechos reservados pertenecen a
          Universidad del Norte Santo Tomás de Aquino - 2023 <br></br>
          <br></br>
          <br></br>
          <br></br>
          <br></br>
